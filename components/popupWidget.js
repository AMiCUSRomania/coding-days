  ...
  return (
    <div>
      <Disclosure>
        {({ open }) => (
          <>
            <Disclosure.Button className="fixed z-40 flex items-center justify-center transition duration-300 bg-rose-800 rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-rose-700 focus:bg-rose-700 ease">
                  ...
                  {!isSubmitSuccessful && (
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                      ...
                      <div className="mb-3">
                        <button
                          type="submit"
                          className="w-full px-3 py-4 text-white bg-rose-800 rounded-md focus:bg-rose-700 focus:outline-none">
                          {isSubmitting ? (
                            <svg
                  ...
                  {isSubmitSuccessful && isSuccess && (
                    <>
                      <div className="flex flex-col items-center justify-center h-full text-center text-white rounded-md">
                        ...
                        <button
                          className="mt-6 text-rose-700 focus:outline-none"
                          onClick={() => reset()}>
                          Go back
                        </button>
                      </div>
